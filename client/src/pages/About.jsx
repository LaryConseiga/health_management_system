    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow bg-gradient-to-br from-blue-50 to-indigo-100 py-16 px-4">
                <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-xl p-10 space-y-10">
                    <div className="text-center">
                        <h1 className="text-4xl font-bold text-gray-900">About MediCare+</h1>
                        <p className="mt-4 text-gray-600 text-lg">
                            A modern healthcare management platform built for efficiency and trust.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        <div className="p-6 rounded-lg bg-blue-50">
                            ...
                            <p className="mt-3 text-gray-600">
                                Simplify healthcare management and improve collaboration between
                        ...
                        <div className="p-6 rounded-lg bg-blue-50">
                            ...
                            <p className="mt-3 text-gray-600">
                                Become a trusted digital solution for healthcare institutions worldwide.
                            </p>
                        </div>
                        ...
                        <div className="p-6 rounded-lg bg-blue-50">
                            ...
                            <p className="mt-3 text-gray-600">
                                Security, reliability, innovation, and patient-centered care.
                            </p>
                        </div>
                    </div>

                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-gray-900">Why MediCare+?</h2>
                        <p className="mt-4 text-gray-600 max-w-3xl mx-auto">
                            MediCare+ provides secure authentication, role-based access,
                            patient data management, and scalable architecture using modern web technologies.
                        </p>
                    </div>
                </div>
            </main>
